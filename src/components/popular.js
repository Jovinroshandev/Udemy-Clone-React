    ...
    return(
        ...
        <div class="course-container__child">
            <div class="course-box">
                <img src={course6} alt="course-image"/>
            ...
            <div class="course-box">
                <img src={course8} alt="course-image"/>
                <div class="card-content">
                    <h2>Sound Engineering Course</h2>
                    <p class="course-box__author-namae">Manoj Kumar (Graphic & VFX Designer)</p>
                    <p class="course-box__rating">2.4 ⭐⭐</p>
                    <p class="course-box__amount">&#8377;599 <del>4,000</del></p>
                </div>
            </div>
            <div class="course-box">
                <img src={course7} alt="course-image"/>
                <div class="card-content">
            ...
            <div class="course-box">
                <img src={course5} alt="course-image"/>
                <div class="card-content">
            ...
            <div class="course-box">
                <img src={course3} alt="course-image"/>
                <div class="card-content">
            ...
            <div class="course-box">
                <img src={course4} alt="course-image"/>
                <div class="card-content">
